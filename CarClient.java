...
public class CarClient{
	...
	private int port;
	private String strIP = "127.0.0.1"; //<--192.168.173.220";

	public void registerSim(){
		try{
			
			DatagramSocket carSocket = new DatagramSocket();
			InetAddress simaddr = InetAddress.getByName("127.0.0.1"); //<--192.168.173.220
			int simport = 50000;
		...
		*/
		...
		String reqMSG = "127.0.0.1:50000,"+ strIP + ":" + strPORT + ",register" + ",REGmsg"; //<-- 192/168.173.1:50000
		//String reqMSG = "000";
	...
	public void requestPOSDIR(){
		try{
			DatagramSocket carSocket = new DatagramSocket();
			InetAddress simaddr = InetAddress.getByName("127.0.0.1");//<--192.168.173.1
			int simport = 50000;
